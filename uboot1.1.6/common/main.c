...
void arm_USBfuse(void)
{
	...
	while(1)
	{
		...
		{
			case '1':
				ExecuteCmd("nand erase 0 0x200000");
				ExecuteCmd("dnw 0x50008000");
				ExecuteCmd("nand write.uboot 0x50008000 0 0x200000");
				break;
			
			case '2':
				ExecuteCmd("nand erase 0x200000 0x300000");
				ExecuteCmd("dnw 0x50008000");
				ExecuteCmd("nand write.i 0x50008000 0x200000 0x80000");
				break;
			case '3':
				ExecuteCmd("nand erase 0x500000 0x1900000");
				ExecuteCmd("dnw 0x50008000");
				ExecuteCmd("nand write.e 0x50008000 0x500000 0x500000");
				break;
					
			case '4':
				ExecuteCmd("nand erase 0x1e00000");
				ExecuteCmd("dnw 0x50008000");
				sprintf(cmd, "nand write.yaffs2 0x50008000 0x1e00000 %x", dn_filesize);
				ExecuteCmd(cmd);
				break;
	...
	while(1)
	{
		...
		switch(select) 
		{
			case '1':
				...
				ExecuteCmd("fatload mmc 0:1 0x50008000 u-boot.bin");
				ExecuteCmd("nand write.uboot 0x50008000 0 0x200000");
				ExecuteCmd("fatload mmc 0:1 0x50008000 logo.bmp");
				ExecuteCmd("nand write.i 0x50008000 0x200000 0x80000");
				ExecuteCmd("fatload mmc 0:1 0x50008000 zImage");
				ExecuteCmd("nand write.e 0x50008000 0x500000 0x500000");
				ExecuteCmd("fatload mmc 0:1 0x50008000 rootfs.yaffs2");
				ExecuteCmd("nand write.yaffs2 0x50008000 0x1e00000 $filesize");
				break;
			...
			case '5':
				ExecuteCmd("nand write.e 0x50008000 0x1e00000 0x10");
				ExecuteCmd("nand erase 0x1e00000");
				ExecuteCmd("fatload mmc 0:1 0x50008000 rootfs.yaffs2");
				ExecuteCmd("nand write.yaffs2 0x50008000 0x1e00000 $filesize");
				break;
...
{
	unsigned char select;
	char *ppp_dev[8]={"lcdsize=35","lcdsize=43","lcdsize=50","lcdsize=56","lcdsize=70","lcdsize=80","lcdsize=VGA800","lcdsize=XGA1024"};
...
void ARMMenu(void)
{
	...
	while(1) {
		...
		printf("[1] Format the nand flash\n");		
		printf("[2] Burn image from SD card\n");
		printf("[3] Burn image from USB\n");	
//		printf("[4] configure the lcd size\n");							
//		printf("[5] Boot the system\n");
		printf("[4] Reboot the u-boot\n");
